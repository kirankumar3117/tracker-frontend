  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[400px] bg-card border border-border p-6 rounded-3xl shadow-2xl">
        ...
        {error && (
          <div className="bg-red-500/15 border border-red-500/30 text-red-500 text-xs font-bold px-3 py-2 rounded-xl text-center uppercase tracking-wider">
            {error}
          </div>
        )}
        ...
        <Button 
          ...
          className="w-full h-11 rounded-xl font-medium border-border hover:bg-muted/50 transition-colors flex items-center justify-center gap-3"
        >
