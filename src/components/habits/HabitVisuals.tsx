  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
      ...
      <div className="bg-card border border-border rounded-2xl p-5 flex flex-col h-[300px]">
        <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-4">Volume Overview</h3>
      ...
      <div className="bg-card border border-border rounded-2xl p-5 flex flex-col h-[300px]">
        <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-4">Consistency Trend (%)</h3>
        <div className="flex-1 w-full relative min-h-0">
          <ResponsiveContainer width="100%" height="100%">
